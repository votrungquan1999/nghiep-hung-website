...
/**
 * Loading component for the admin projects page.
 * Displays skeleton placeholders while the projects data is being fetched.
 */
	...
	return (
		<div className="container mx-auto p-6 space-y-6">
			...
			<div className="space-y-4">
				...
				{[1, 2, 3, 4, 5].map((item) => (
					<div key={`project-skeleton-${item}`} className="grid grid-cols-12 gap-4 p-4 border-b">
