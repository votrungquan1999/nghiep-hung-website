...
import { Form, FormPendingMessage, FormSubmitMessage } from "src/components/form-state";
import { ImageUploadArea, ImageUploadError, ImageUploadRoot } from "src/components/image-upload";
import { Button } from "src/components/ui/button";
import { DialogClose } from "src/components/ui/dialog";
import { cn } from "src/lib/utils";
import { updateProjectImages } from "./image-management.actions";
import {
	useExistingImages,
...
interface ProjectImageManagementContentProps {
	projectId: string;
}
/**
 ...
 */
export function ProjectImageManagementContent({ projectId }: ProjectImageManagementContentProps) {
	return (
		<Form action={updateProjectImages}>
			<ImagesSection projectId={projectId} />
 ...
 */
function ImagesSection({ projectId }: ImagesSectionProps) {
		...
		<div className="space-y-4">
			<div className="space-y-2">
				...
				<p className="text-xs text-muted-foreground">
					Click on any image to set it as the main project image. Click the X to remove images.
				</p>
			</div>
			...
			<FormDataInputs projectId={projectId} />
...
function FormDataInputs({ projectId }: FormDataInputsProps) {
