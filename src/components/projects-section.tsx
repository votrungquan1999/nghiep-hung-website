...
export default function ProjectsSection() {
	const projects = [
		...
		},
		{
			...
			year: "2022",
			description:
				"Thi công hệ thống ống gió cho bệnh viện với yêu cầu khắt khe về vệ sinh và kiểm soát nhiễm khuẩn.",
		...
		},
		{
			...
			year: "2022",
			description:
				"Lắp đặt hệ thống ống gió cho 500 căn hộ cao cấp, tối ưu hóa không gian và hiệu quả năng lượng.",
			mainImage: "/placeholder.svg?height=400&width=600",
			images: [
				"/placeholder.svg?height=300&width=400",
				"/placeholder.svg?height=300&width=400",
