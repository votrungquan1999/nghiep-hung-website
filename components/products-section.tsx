  ...
  const products = [
    {
      ...
      gallery: ["/round-air-ducts.png", "/round-air-duct-installation.png", "/round-air-duct-factory.png"],
    },
    {
      name: "Ống gió vuông",
      description:
      ...
      gallery: ["/square-air-ducts.png", "/square-air-duct-system.png", "/square-air-duct-manufacturing.png"],
    },
    {
    ...
    },
    {
      ...
      gallery: ["/soundproof-air-duct.png", "/soundproof-air-duct-installation.png", "/acoustic-air-duct-system.png"],
    },
    {
      name: "Ống gió mềm",
      description:
      ...
      gallery: ["/placeholder-tka3n.png", "/flexible-air-duct-installation.png", "/flexible-air-duct-coil.png"],
    },
    {
      ...
      gallery: ["/placeholder-pt0v2.png", "/air-filtration-system.png", "/air-purifier-installation.png"],
    },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product, index) => (
            <ProductGalleryDialog key={index} product={product}>
